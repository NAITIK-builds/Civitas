      ...
      <section className="relative bg-gradient-to-r from-gov-navy via-gov-navy to-gov-maroon text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="bg-white rounded-xl shadow-2xl border border-gray-100 p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
              {stats.map((stat, index) => {
                ...
                return (
                  <div key={index} className="text-center p-3 sm:p-4 lg:p-6 rounded-lg border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              {[
                ...
                return (
                  <div key={index} className="text-center relative">
                    {index < 3 && (
                      <div className="hidden md:block absolute top-6 left-full w-full h-0.5 bg-gov-gold/30 z-0"></div>
                    )}
